var capitals = [
    // 2020-04-06
    {center: [116.165108,40.128678],aa: "1",name: "沙阳路东贯市东路口西西向东（辅路）",text: '沙阳路东贯市东路口西西向东（辅路）' },
    {center: [116.427425,39.85851],aa: "1",name: "刘家窑桥东过街桥内环辅路",text: '刘家窑桥东过街桥内环辅路' },
    ...
    {center: [116.453659,39.832722],aa: "2",name: "肖村桥东过街桥方向不明",text: '肖村桥东过街桥方向不明' },
    ...
    {center: [116.491525,39.9903],aa: "2",name: "机场辅路大山桥北南北双向",text: '机场辅路大山桥北南北双向' },
    ...
    {center: [116.696175,39.869588],aa: "2",name: "103国道土桥新桥西东西双向",text: '103国道土桥新桥西东西双向' },
    {center: [116.439799,40.01602],aa: "2",name: "顾家庄桥南南向北",text: '顾家庄桥南南向北' },
    {center: [116.577134,39.755885],aa: "2",name: "融商六路马驹桥东站西北向南",text: '融商六路马驹桥东站西北向南' },
    ...
    {center: [116.354271,39.852031],aa: "2",name: "三环玉泉营桥东外环主路（辅路也有暂时不明）",text: '三环玉泉营桥东外环主路（辅路也有暂时不明）' },
    ...
    {center: [116.708631,39.887627],aa: "1",name: "滨河中路小圣庙桥西 东向西",text: '滨河中路小圣庙桥西 东向西' },
    ...
    {center: [116.537185,39.947449],aa: "1",name: "五环路平房桥北 双向",text: '五环路平房桥北 双向' },
    ...
    {center: [116.162947,39.77428],aa: "1",name: "京港澳京良桥下南向北",text: '京港澳京良桥下南向北' },
    {center: [116.110014,39.720445],aa: "2",name: "阎村桥下北向南",text: '阎村桥下北向南' },
    ...
    {center: [116.517751,39.97759],aa: "1",name: "将台东路八门房村口东向西",text: '将台东路八门房村口东向西' },
    ...
    {center: [116.70796,39.986943],aa: "1",name: "徐尹路徐辛庄桥西东向西",text: '徐尹路徐辛庄桥西东向西' },
    ...
    {center: [116.499389,39.81766],aa: "1",name: "五环大羊坊桥西外环双向",text: '五环大羊坊桥西外环双向' },
    ...
    {center: [116.440615,39.858953],aa: "1",name: "南三环方庄桥东西向东",text: '南三环方庄桥东西向东' },
    ...
    {center: [116.535744,39.916479],aa: "2",name: "大黄庄桥西双向",text: '大黄庄桥西双向' },
    ...
    {center: [116.270215,40.007185],aa: "1",name: "红山桥下黑山扈路南向北",text: '红山桥下黑山扈路南向北' },
