var capitals = [
    // 2020-05-19
    {center: [116.421969,39.859534],aa: "2",name: "刘家窑北龙门 北向南",text: '刘家窑北龙门 北向南' },
    {center: [116.270306,40.006025],aa: "1",name: "红山桥下北向南",text: '红山桥下北向南' },
    {center: [116.316845,39.980442],aa: "2",name: "中关村环岛南向北",text: '中关村环岛南向北' },
    {center: [116.657965,39.829142],aa: "2",name: "九德路台湖南口南 南北双向",text: '九德路台湖南口南 南北双向' },
    {center: [116.705506,39.936931],aa: "2",name: "京榆旧路六合桥西 西向东",text: '京榆旧路六合桥西 西向东' },
    {center: [116.282943,39.865301],aa: "2",name: "丰北桥东向西",text: '丰北桥东向西' },
    {center: [116.333476,39.981139],aa: "1",name: "中关村南路东口南向北",text: '中关村南路东口南向北' },
    {center: [116.393632,39.857069],aa: "2",name: "洋桥东过街桥 西向东",text: '洋桥东过街桥 西向东' },
    {center: [115.970699,40.458488],aa: "2",name: "苏子街西口至长青削面馆路口段",text: '苏子街西口至长青削面馆路口段' },
    {center: [116.416423,39.950856],aa: "1",name: "和平里西街地坛南门",text: '和平里西街地坛南门' },
    {center: [116.443201,39.947592],aa: "1",name: "东直门外大街春秀路北口",text: '东直门外大街春秀路北口' },
    {center: [116.432387,39.952176],aa: "1",name: "东土城路建材大厦前",text: '东土城路建材大厦前' },
    {center: [116.348233,39.877574],aa: "1",name: "鸭子桥路白纸坊桥西200M 东向西",text: '鸭子桥路白纸坊桥西200M 东向西' },
    {center: [116.479778,39.964545],aa: "1",name: "霄云桥东南过街桥外环主路",text: '霄云桥东南过街桥外环主路' },
    {center: [115.969211,40.465551],aa: "1",name: "北关北口至玉皇阁大街北口段",text: '北关北口至玉皇阁大街北口段' },
    {center: [115.990494,40.467232],aa: "1",name: "香水苑小区南门至劳动局路口段",text: '香水苑小区南门至劳动局路口段' },
    {center: [116.38778,39.865498],aa: "2",name: "马家堡东路四路通口南天桥 南向北",text: '马家堡东路四路通口南天桥 南向北' },
    {center: [116.584868,39.950998],aa: "2",name: "管庄桥北天桥 北向南",text: '管庄桥北天桥 北向南' },
    {center: [116.401867,39.820957],aa: "2",name: "久敬庄南 南北双向",text: '久敬庄南 南北双向' },
    {center: [116.385904,39.758571],aa: "2",name: "五环41公里200米/团河桥东已建龙门处 双向",text: '五环41公里200米/团河桥东已建龙门处 双向' },
    {center: [116.339132,39.849124],aa: "2",name: "玉泉营桥西过街桥内环辅路",text: '玉泉营桥西过街桥内环辅路' },
    {center: [116.307862,39.963973],aa: "1",name: "苏州桥北 南向北",text: '苏州桥北 南向北' },
    {center: [116.522696,39.835907],aa: "2",name: "老君堂桥北由北向南",text: '老君堂桥北由北向南' },
    {center: [116.317363,39.923814],aa: "2",name: "航天桥东过街天桥 西向东",text: '航天桥东过街天桥 西向东' },
    {center: [116.352252,39.831083],aa: "2",name: "马家楼桥东过街桥外环主路",text: '马家楼桥东过街桥外环主路' },
    {center: [116.325225,39.830611],aa: "2",name: "花乡桥东过街桥双向主路",text: '花乡桥东过街桥双向主路' },
    {center: [116.274552,39.885038],aa: "2",name: "岳各庄北桥北过街桥双向主路",text: '岳各庄北桥北过街桥双向主路' },
    {center: [116.274004,39.893532],aa: "2",name: "南沙窝桥南过街桥双向主路",text: '南沙窝桥南过街桥双向主路' },
    {center: [116.199428,39.907468],aa: "2",name: "八角路口东 东西双向",text: '八角路口东 东西双向' },
    {center: [116.461193,39.918268],aa: "2",name: "兆丰街西口 西向东",text: '兆丰街西口 西向东' },
    {center: [116.466542,39.933726],aa: "2",name: "长虹桥西天桥东向西",text: '长虹桥西天桥东向西' },
    {center: [116.352605,39.91846],aa: "1",name: "月坛北街月坛北门西西向东",text: '月坛北街月坛北门西西向东' },
    {center: [116.291403,39.841504],aa: "1",name: "丰台南路向阳街路口东向西（高峰）",text: '丰台南路向阳街路口东向西（高峰）' },
    {center: [116.388017,39.976877],aa: "1",name: "北辰西路南口东向西（高峰）",text: '北辰西路南口东向西（高峰）' },
    {center: [116.246273,39.693241],aa: "1",name: "兴良路与左堤路交叉口西西向东",text: '兴良路与左堤路交叉口西西向东' },
    {center: [116.410041,39.857478],aa: "1",name: "沙子口路南口北 南向北",text: '沙子口路南口北 南向北' },
    {center: [115.990063,40.457698],aa: "2",name: "延庆小营桥北 南向北",text: '延庆小营桥北 南向北' },
    {center: [116.332603,39.722811],aa: "2",name: "兴华大街与林校北路路口北向南",text: '兴华大街与林校北路路口北向南' },
    {center: [116.313145,39.945562],aa: "1",name: "万寿寺路广源闸人行横道东向西",text: '万寿寺路广源闸人行横道东向西' },
    {center: [116.441055,39.908465],aa: "1",name: "建外大街日坛路口由东向西",text: '建外大街日坛路口由东向西' },
    {center: [116.352591,39.907408],aa: "2",name: "南礼士路南口由南向北",text: '南礼士路南口由南向北' },
    {center: [116.374,39.914749],aa: "1",name: "灵境胡同西口 西向东",text: '灵境胡同西口 西向东' },
    {center: [116.354198,39.869761],aa: "2",name: "菜户营桥大观园牌楼由北向南",text: '菜户营桥大观园牌楼由北向南' },
    {center: [116.517275,39.931405],aa: "1",name: "青年路国美第一城路口北向南（高峰）",text: '青年路国美第一城路口北向南（高峰）' },
    {center: [116.400635,39.845541],aa: "2",name: "南苑路与石榴庄路交口南向北",text: '南苑路与石榴庄路交口南向北' },
    {center: [116.354351,39.867469],aa: "2",name: "玉林西路菜户营桥南30米南向北",text: '玉林西路菜户营桥南30米南向北' },
    {center: [116.364316,39.868887],aa: "2",name: "右安门外大街右安门桥南 南北双向",text: '右安门外大街右安门桥南 南北双向' },
    {center: [116.374984,40.013595],aa: "1",name: "林萃路与关西南街交叉口南向北",text: '林萃路与关西南街交叉口南向北' },
    {center: [116.302253,39.974868],aa: "2",name: "稻香园桥东行人过街东向西",text: '稻香园桥东行人过街东向西' },
    {center: [116.401196,39.891869],aa: "1",name: "珠市口东大街前门东路南口东西向",text: '珠市口东大街前门东路南口东西向' },
    {center: [116.449825,39.960268],aa: "1",name: "静安东街北口南南向北",text: '静安东街北口南南向北' },
    {center: [116.400114,39.860906],aa: "1",name: "木樨园桥北百荣世贸商城前南向北",text: '木樨园桥北百荣世贸商城前南向北' },
    {center: [116.252844,39.875637],aa: "2",name: "小屯路（城乡超市门口）北向南",text: '小屯路（城乡超市门口）北向南' },
    ...
    {center: [116.483598,39.803575],aa: "2",name: "文化园西路与科慧大道交口东西双向",text: '文化园西路与科慧大道交口东西双向' },
    ...
    {center: [116.427425,39.85851],aa: "2",name: "刘家窑桥东过街桥双向主辅路",text: '刘家窑桥东过街桥双向主辅路' },
    ...
    {center: [116.345774,39.83094],aa: "2",name: "京开马家楼桥进出京双向",text: '京开马家楼桥进出京双向' },
    ...
    {center: [116.264626,39.90748],aa: "2",name: "复兴路与永定路交叉口四个方向",text: '复兴路与永定路交叉口四个方向' },
    ...
    {center: [116.252529,39.907369],aa: "2",name: "复兴路与玉泉路交叉口西向东、南向北",text: '复兴路与玉泉路交叉口西向东、南向北' },
    ...
    {center: [116.323524,40.172376],aa: "2",name: "顺沙路与南百路口北南北双向",text: '顺沙路与南百路口北南北双向' },
    ...
    {center: [116.145465,40.068067],aa: "2",name: "北清路高里掌北桥西向东 主辅路",text: '北清路高里掌北桥西向东 主辅路' },
    {center: [116.388192,39.967691],aa: "2",name: "双旗杆路北口南",text: '双旗杆路北口南' },
    {center: [116.374973,39.765505],aa: "2",name: "五环敬贤桥外环",text: '五环敬贤桥外环' },
    {center: [116.31308,39.743493],aa: "2",name: "兴旺路与清源路路口 南北双向",text: '兴旺路与清源路路口 南北双向' },
    ...
    {center: [116.461992,39.94126],aa: "2",name: "三环辅路农展桥南向北",text: '三环辅路农展桥南向北' },
    ...
    {center: [116.3103,39.898384],aa: "2",name: "三环莲花桥 双向 内环辅路",text: '三环莲花桥 双向 内环辅路' },
    ...
    {center: [116.697452,39.863215],aa: "2",name: "张采路张家湾北桥北 南北双向",text: '张采路张家湾北桥北 南北双向' },
    ...
    {center: [116.439799,40.01602],aa: "2",name: "顾家庄桥南路口南 南向北",text: '顾家庄桥南路口南 南向北' },
    ...
    {center: [116.429694,39.811523],aa: "1",name: "东高地路口南向北(高峰)",text: '东高地路口南向北(高峰)' },
    ...
    {center: [116.454178,39.862434],aa: "2",name: "三环分钟寺桥内环主路",text: '三环分钟寺桥内环主路' },
    {center: [116.404139,39.857032],aa: "2",name: "三环木樨园桥东过街天桥 东向西辅路",text: '三环木樨园桥东过街天桥 东向西辅路' },
    ...
    {center: [116.327225,39.985807],aa: "2",name: "四环中关村三桥西向东",text: '四环中关村三桥西向东' },
    ...
    {center: [116.489833,39.922831],aa: "4",name: "红领巾桥内环主路（疑似高峰）",text: '红领巾桥内环主路（疑似高峰）' },
    ...
    {center: [116.374495,39.856878],aa: "2",name: "万芳桥东天桥双向主辅路",text: '万芳桥东天桥双向主辅路' },
    ...
    {center: [116.343019,39.742578],aa: "2",name: "清源路/龙河路(路口)东向西",text: '清源路/龙河路(路口)东向西' },
    {center: [116.381788,39.758059],aa: "2",name: "五环路主路团河桥双向",text: '五环路主路团河桥双向' },
    {center: [116.638979,39.812815],aa: "1",name: "铺大路蒋新庄桥南 北向南",text: '铺大路蒋新庄桥南 北向南' },
    {center: [116.503047,39.971839],aa: "2",name: "将台路驼房营路口北向南",text: '将台路驼房营路口北向南' },
    {center: [116.322431,39.777631],aa: "1",name: "北兴路与兴业大街交叉口东向西",text: '北兴路与兴业大街交叉口东向西' },
    {center: [116.446464,39.986201],aa: "2",name: "望和桥东过街天桥主路双向",text: '望和桥东过街天桥主路双向' },
    ...
    {center: [116.678806,40.008845],aa: "2",name: "通顺路北窑上桥南南北双向",text: '通顺路北窑上桥南南北双向' },
    {center: [116.123531,39.793115],aa: "2",name: "泉湖东路刘太庄南路口东西双向",text: '泉湖东路刘太庄南路口东西双向' },
    {center: [116.322224,39.699419],aa: "1",name: "新源大街盛源桥北 南北双向",text: '新源大街盛源桥北 南北双向' },
    ...
    {center: [116.244689,40.213321],aa: "2",name: "南环东路与燕平街路口北南向北",text: '南环东路与燕平街路口北南向北' },
    ...
    {center: [116.226516,40.229326],aa: "2",name: "北环路与西环路交叉口（北向南 西向东）",text: '北环路与西环路交叉口（北向南 西向东）' },
    ...
    {center: [116.213481,39.698792],aa: "2",name: "107国道葫芦垡桥北南北双向",text: '107国道葫芦垡桥北南北双向' },
    {center: [116.241162,39.858988],aa: "1",name: "京港澳高速大瓦窑桥双向",text: '京港澳高速大瓦窑桥双向' },
    {center: [116.381889,39.721757],aa: "2",name: "黄马路与团桂路刘二村口 东西双向",text: '黄马路与团桂路刘二村口 东西双向' },
    {center: [116.445204,39.859637],aa: "1",name: "方庄东路三环内",text: '方庄东路三环内' },
    {center: [116.211387,39.916642],aa: "1",name: "五环主路五景桥双向",text: '五环主路五景桥双向' },
    {center: [116.302919,40.088781],aa: "2",name: "京藏二拨子桥下双向",text: '京藏二拨子桥下双向' },
    {center: [116.710458,39.902392],aa: "1",name: "运河东大街杨坨桥西双向",text: '运河东大街杨坨桥西双向' },
    ...
    {center: [116.417268,39.857121],aa: "2",name: "赵公口桥东过街桥外环辅路",text: '赵公口桥东过街桥外环辅路' },
    {center: [116.419784,39.768547],aa: "2",name: "五环饮鹿池桥内环",text: '五环饮鹿池桥内环' },
    {center: [116.329975,39.777062],aa: "2",name: "兴华大街与北兴路交叉口 双向",text: '兴华大街与北兴路交叉口 双向' },
    {center: [116.489743,39.887097],aa: "2",name: "大郊亭桥南天桥双向",text: '大郊亭桥南天桥双向' },
    {center: [116.545084,39.74658],aa: "2",name: "黄马路马驹桥1号楼西东向西",text: '黄马路马驹桥1号楼西东向西' },
    ...
    {center: [116.706361,39.909999],aa: "1",name: "玉带河大街东六环西侧路路口东西双向",text: '玉带河大街东六环西侧路路口东西双向' },
    {center: [116.527573,39.767434],aa: "1",name: "博兴三路西环路交叉口",text: '博兴三路西环路交叉口' },
    {center: [116.316331,39.780959],aa: "2",name: "南五环李营桥双向",text: '南五环李营桥双向' },
    {center: [116.593463,40.139675],aa: "1",name: "101国道六元桥南北向南南北双向",text: '101国道六元桥南北向南南北双向' },
    {center: [116.552657,40.143538],aa: "2",name: "火寺路张喜庄桥南南北双向",text: '火寺路张喜庄桥南南北双向' },
    {center: [116.649436,40.059496],aa: "2",name: "龙塘路龙苏路桥西 东西双向",text: '龙塘路龙苏路桥西 东西双向' },
    ...
    {center: [116.688763,40.001884],aa: "2",name: "窑平路王辛庄桥西 东西双向",text: '窑平路王辛庄桥西 东西双向' },
    {center: [116.124327,39.938718],aa: "2",name: "阜石路双峪桥东东西双向",text: '阜石路双峪桥东东西双向' },
    {center: [116.127186,39.939141],aa: "2",name: "双峪路与麻峪东街路口西东西双向",text: '双峪路与麻峪东街路口西东西双向' },
    {center: [116.247606,40.171365],aa: "2",name: "顺沙路百葛桥信号灯路口东向西",text: '顺沙路百葛桥信号灯路口东向西' },
    {center: [116.245498,40.164502],aa: "2",name: "京藏高速西沙桥下南北双向",text: '京藏高速西沙桥下南北双向' },
    ...
    {center: [116.499389,39.81766],aa: "2",name: "五环大羊坊桥西双向",text: '五环大羊坊桥西双向' },
    {center: [116.461683,39.929507],aa: "1",name: "三环长虹桥南过街桥外环",text: '三环长虹桥南过街桥外环' },
    {center: [116.446422,39.846332],aa: "2",name: "成寿寺成仪路东口北北向南",text: '成寿寺成仪路东口北北向南' },
    {center: [116.531662,39.892923],aa: "2",name: "广渠路高碑店污水处理厂门口东西双向",text: '广渠路高碑店污水处理厂门口东西双向' },
    {center: [116.21755,39.96104],aa: "2",name: "五环主路杏石口北天桥双向",text: '五环主路杏石口北天桥双向' },
    {center: [116.365576,39.831059],aa: "2",name: "公益西桥西天桥西向东",text: '公益西桥西天桥西向东' },
    {center: [116.411743,39.832279],aa: "4",name: "大红门东桥内环",text: '大红门东桥内环' },
    ...
    {center: [116.489788,39.884017],aa: "4",name: "四环主路窑洼湖桥北外环",text: '四环主路窑洼湖桥北外环' },
    ...
    {center: [116.397925,39.832152],aa: "4",name: "大红门桥内环",text: '大红门桥内环' },
    {center: [116.281519,39.869178],aa: "2",name: "丰北桥北过街桥双向主路",text: '丰北桥北过街桥双向主路' },
    {center: [116.438679,39.859579],aa: "1",name: "方庄桥北南向北",text: '方庄桥北南向北' },
    {center: [116.432103,39.859125],aa: "1",name: "东铁营桥北南北双向",text: '东铁营桥北南北双向' },
    {center: [116.311722,39.874145],aa: "2",name: "西三环丽泽桥北第二过街桥双向",text: '西三环丽泽桥北第二过街桥双向' },
    {center: [116.47211,39.808927],aa: "1",name: "亦庄桥北南北双向",text: '亦庄桥北南北双向' },
    ...
    {center: [116.287739,40.011045],aa: "2",name: "万泉河快速路肖家河桥南双向（包括北向辅路）",text: '万泉河快速路肖家河桥南双向（包括北向辅路）' },
    {center: [116.31024,39.904676],aa: "1",name: "西三环新兴桥南内环",text: '西三环新兴桥南内环' },
    {center: [116.323903,39.850914],aa: "2",name: "西三环丰益桥南过街桥外环主路",text: '西三环丰益桥南过街桥外环主路' },
    ...
    {center: [116.283527,39.84887],aa: "2",name: "丰台大桥北过街桥双向主路",text: '丰台大桥北过街桥双向主路' },
    ...
    {center: [116.462754,39.833724],aa: "4",name: "四环主路小红门桥东西向东",text: '四环主路小红门桥东西向东' },
    ...
    {center: [116.451948,39.792371],aa: "2",name: "旧忠桥北南北双向",text: '旧忠桥北南北双向' },
    {center: [116.38677,39.857816],aa: "1",name: "洋桥北南北双向",text: '洋桥北南北双向' },
    {center: [116.442041,39.884511],aa: "1",name: "光明桥西东西双向",text: '光明桥西东西双向' },
    {center: [116.313819,39.789134],aa: "2",name: "欣羊桥北 四个方向",text: '欣羊桥北 四个方向' },
    ...
    {center: [116.504673,39.819882],aa: "2",name: "京沪大羊坊桥下双向",text: '京沪大羊坊桥下双向' },
    ...
    {center: [116.212513,39.903874],aa: "2",name: "鲁谷桥东东西双向",text: '鲁谷桥东东西双向' },
    ...
    {center: [116.540478,39.847642],aa: "2",name: "化工桥西大鲁店北路西向东",text: '化工桥西大鲁店北路西向东' },
    ...
    {center: [116.274343,40.003593],aa: "2",name: "颐和园路颐和园北宫门南北双向",text: '颐和园路颐和园北宫门南北双向' },
    {center: [116.269652,40.005508],aa: "2",name: "红山桥下东向西（不是五环路，是五环下面）",text: '红山桥下东向西（不是五环路，是五环下面）' },
    ...
    {center: [116.538964,39.86934],aa: "2",name: "京哈五方桥西/京哈高速4公里 双向",text: '京哈五方桥西/京哈高速4公里 双向' },
    {center: [116.357763,40.017804],aa: "2",name: "京藏高速上清桥南天桥南北双向（包括辅路）",text: '京藏高速上清桥南天桥南北双向（包括辅路）' },
